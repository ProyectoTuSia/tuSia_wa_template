...
export default function CustomTuiModal({
  ...
  useLayoutEffect(() => {
    if (schedule) {
      ...
      setAttendeeId(attendees.find((element) => schedule.attendees.includes(element.name)).id);
        ...
        <div style={{ display: "flex" }}>
          ...
          >
            ...
            >
              <span
                ...
                style={{
                  backgroundColor: calendars.find((element) => element.id === calendarId).bgColor,
                }}
              />
              <span
          ...
          >
            ...
            >
              ...
              <span id="tui-full-calendar-schedule-state" className="tui-full-calendar-content">
